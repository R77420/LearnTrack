...
class APIService {
    ...
    private func request<T: Decodable>(_ endpoint: String, method: String = "GET", body: [String: Any]? = nil) async throws -> T {
        ...
        case 200, 201:
            // Handle empty response for 201 Created if the API returns no content but the model expects it,
            // or if the API returns just "OK".
            // However, the provided examples suggest it returns the object.
